/*!40103 SET @OLD_TIME_ZONE=@@TIME_ZONE */; /*!40103 SET TIME_ZONE='+00:00' */; /*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */; /*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */; /*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */; /*!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */; DROP TABLE IF EXISTS `game_event`; /*!40101 SET @saved_cs_client = @@character_set_client */; /*!40101 SET character_set_client = utf8 */; CREATE TABLE `game_event` ( `eventEntry` tinyint(3) unsigned NOT NULL COMMENT 'Entry of the game event', `start_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Absolute start date, the event will never start before', `end_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Absolute end date, the event will never start afler', `occurence` bigint(20) unsigned NOT NULL DEFAULT '5184000' COMMENT 'Delay in minutes between occurences of the event', `length` bigint(20) unsigned NOT NULL DEFAULT '2592000' COMMENT 'Length in minutes of the event', `holiday` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Client side holiday id', `description` varchar(255) DEFAULT NULL COMMENT 'Description of the event displayed in console', `world_event` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '0 if normal event, 1 if world event', PRIMARY KEY (`eventEntry`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8; /*!40101 SET character_set_client = @saved_cs_client */; LOCK TABLES `game_event` WRITE; /*!40000 ALTER TABLE `game_event` DISABLE KEYS */; INSERT INTO `game_event` VALUES (1,'2012-06-20 23:01:00','2020-12-31 05:00:00',525600,20160,341,'Midsummer Fire Festival',0),
(2,'2012-12-15 06:00:00','2020-12-31 05:00:00',525600,25920,141,'Winter Veil',0),
(3,'2013-02-03 00:01:00','2020-12-31 05:00:00',131040,8639,376,'Darkmoon Faire (Terokkar Forest)',0),
(4,'2013-03-03 00:01:00','2020-12-31 05:00:00',131040,8639,374,'Darkmoon Faire (Elwynn Forest)',0),
(5,'2013-01-06 00:01:00','2020-12-31 05:00:00',131040,8639,375,'Darkmoon Faire (Mulgore)',0),
(6,'2010-01-01 06:00:00','2020-12-31 05:00:00',525600,120,0,'New Year\'s Eve',0),
(7,'2011-01-23 00:01:00','2020-12-31 05:00:00',525600,27360,327,'Lunar Festival',0),
(8,'2012-02-05 00:01:00','2020-12-31 05:00:00',525600,20160,423,'Love is in the Air',0),
(9,'2012-04-07 23:01:00','2020-12-31 05:00:00',524160,10080,181,'Noblegarden',0),
(10,'2012-04-28 23:01:00','2020-12-31 05:00:00',525600,10080,201,'Children\'s Week ',0),
(11,'2012-09-18 00:00:00','2020-12-31 05:00:00',525600,10080,321,'Harvest Festival',0),
(12,'2011-10-18 00:00:00','2020-12-31 05:00:00',525600,20160,324,'Hallow\'s End',0),
(13,'0000-00-00 00:00:00','0000-00-00 00:00:00',525600,1,0,'Elemental Invasions',0),
(14,'2012-01-01 00:00:00','2020-12-31 05:00:00',10080,1440,0,'Stranglethorn Fishing Extravaganza Announce',0),
(15,'2012-01-01 14:00:00','2020-12-31 05:00:00',10080,120,301,'Stranglethorn Fishing Extravaganza Fishing Pools',0),
...
(23,'2011-03-03 00:01:00','2020-12-31 05:00:00',131040,4320,0,'Darkmoon Faire Building (Elwynn Forest)',0),
(24,'2012-09-19 23:01:00','2020-12-31 05:00:00',525600,21600,372,'Brewfest',0),
(25,'2008-01-02 21:00:00','2020-12-31 05:00:00',1440,720,0,'Nights',0),
(26,'2012-11-18 01:00:00','2020-12-31 05:00:00',525600,10020,404,'Pilgrim\'s Bounty',0),
...
(50,'2012-09-18 23:01:00','2020-12-31 04:00:00',525600,1440,398,'Pirates\' Day',0),
(51,'2012-11-01 01:00:00','2020-12-31 05:00:00',525600,2820,409,'Day of the Dead',0),
(52,'2010-12-25 05:00:00','2020-12-31 05:00:00',525600,11700,0,'Winter Veil: Gifts',0),
...
(62,'2012-01-01 14:00:00','2020-12-31 05:00:00',10080,180,0,'Stranglethorn Fishing Extravaganza Turn-ins',0),
(63,'2012-01-07 13:00:00','2020-12-31 05:00:00',10080,180,424,'Kalu\'ak Fishing Derby Turn-ins',0),
(64,'2012-01-07 14:00:00','2020-12-31 05:00:00',10080,60,0,'Kalu\'ak Fishing Derby Fishing Pools',0); /*!40000 ALTER TABLE `game_event` ENABLE KEYS */; UNLOCK TABLES; /*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */; /*!40101 SET SQL_MODE=@OLD_SQL_MODE */; /*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */; /*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */; /*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */;
